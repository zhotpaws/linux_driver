/* **************** LFD331:4.2 s_26/lab1_transmit.c **************** */
/*
...
static int my_start_xmit(struct sk_buff *skb, struct net_device *dev)
{
	...
	netdev_info(dev, "my_start_xmit(%s)\n", dev->name);
...
{
	netdev_info(dev, "my_change_mtu(%s)\n", dev->name);
	return -1;
}
...
MODULE_DESCRIPTION("LFD331:4.2 s_26/lab1_transmit.c");
