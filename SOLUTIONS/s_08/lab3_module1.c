/* **************** LFD331:4.2 s_08/lab3_module1.c **************** */
/*
 ...
 * adapt it to use dynamic loading with request_module().
 *
...
void mod_fun(void)
{
	dev_info(my_dev, " VOILA! I got into mod_fun\n");
}
EXPORT_SYMBOL(mod_fun);
static int mycdrv_open(struct inode *inode, struct file *file)
{
	dev_info(my_dev, "/n rc from requesting module mod_fun is: %d\n",
...
MODULE_DESCRIPTION("LFD331:4.2 s_08/lab3_module1.c");
