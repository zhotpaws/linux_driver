/* **************** LFD331:4.2 s_16/lab4_relay_module.c **************** */
/*
...
*create_buf_file_handler(const char *filename,
			 ...
			 modetype mode, struct rchan_buf *buf, int *is_global)
{
...
MODULE_DESCRIPTION("LFD331:4.2 s_16/lab4_relay_module.c");
